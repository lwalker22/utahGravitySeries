  ...
  <Layout>
    <div>
      <a href="https://www.go-ride.com/" target="blank">
        <img src={logo3} alt="goride_logo" style={{ width: "auto", height: "5em"}} />
      </a>
    </div>
    <div>
      <a href="https://www.giro.com/" target="blank">
        <img src={logo2} alt="giro_logo" style={{ width: "auto", height: "1em"}} />
      </a>
    </div>
    <div>
      <a href="http://www.ebaystores.com/TruckerCo-High-Performance-Parts?_rdc=1" target="blank">
        <img src={logo7} alt="truckerco_logo" style={{ width: "auto", height: ".7em"}} />
      </a>
    </div>
    <div>
      <a href="https://trpcycling.com/" target="blank">
        <img src={logo6} alt="trp_logo" style={{ width: "auto", height: "2em"}} />
      </a>
    </div>
    <div>
      <a href="http://www.bohemianbrewery.com/" target="blank">
        <img src={logo1} alt="bohemian_logo" style={{ width: "auto", height: "5em"}} />
      </a>
    </div>
    <div>
      <a href="https://www.stanley-pmi.com/" target="blank">
        <img src={logo5} alt="stanley_logo" style={{ width: "auto", height: "4em"}} />
      </a>
    </div>
    <div>
      <a href="https://www.gtbicycles.com/usa_en/" target="blank">
        <img src={logo4} alt="gtfactory_logo" style={{ width: "auto", height: "2em"}} />
      </a>
    </div>
  </Layout>
)
